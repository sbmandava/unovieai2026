      ...
      <section className="pt-32 pb-20 container mx-auto px-6">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-display font-bold mb-8">
            From documents to <br/><span className="text-gradient">understanding.</span>
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
            Nexus reads your documents and builds something that did not exist before: a living graph of your organization's context. No manual curation required.
          </p>
        </motion.div>
      </section>
